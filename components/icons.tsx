...
export const TrophyIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 16.5c-1.437 1.437-3.375 1.437-4.812 0m4.812 0c1.437-1.437 1.437-3.375 0-4.812M13.562 16.5c1.437-1.437 3.375-1.437 4.812 0m-4.812 0c-1.437 1.437-1.437 3.375 0 4.812M10.125 12c-1.437-1.437-3.375-1.437-4.812 0m4.812 0c1.437 1.437 1.437 3.375 0 4.812M5.312 12c1.437 1.437 3.375 1.437 4.812 0m-4.812 0c-1.437-1.437-1.437-3.375 0-4.812M7.5 3.75c0 .621.504 1.125 1.125 1.125h.375c.621 0 1.125-.504 1.125-1.125V3h-2.625v.75Zm0 0V3.75m0 0h.375m2.25 0h.375m-.375 0v.375m0 0v-.375m0 0h.375M15 3.75c0 .621.504 1.125 1.125 1.125h.375c.621 0 1.125-.504 1.125-1.125V3h-2.625v.75Zm0 0V3.75m0 0h.375m2.25 0h.375m-.375 0v.375m0 0v-.375m0 0h.375m-9.75 9.375c0-1.036.84-1.875 1.875-1.875h4.5c1.035 0 1.875.84 1.875 1.875v.375c0 1.036-.84 1.875-1.875 1.875h-4.5A1.875 1.875 0 0 1 8.25 13.5v-.375Z" />
  </svg>
);

export const ClipboardCheckIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-1.125 0-2.062.938-2.062 2.063v15.374c0 1.125.938 2.063 2.063 2.063h10.25c1.125 0 2.063-.938 2.063-2.063V4.312m-7.25-2.062c.375-.375.875-.625 1.438-.625h1.625c.562 0 1.062.25 1.437.625m-3.5 0S11.25 1.5 12 1.5s1.875.75 1.875.75m-3.5 0h3.5m-3.5 0V6m6.5 6.375l-2.125 2.125-1.25-1.25m3.375-3.375-3.375 3.375a1.125 1.125 0 01-1.591 0L7.5 12.75" />
    </svg>
);
...
export const BanknotesIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V6.375m0 0V6m0 0h.375m0 0a1.125 1.125 0 0 0-1.125-1.125H3.75m16.5 0h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V6.375c0-.621.504-1.125 1.125-1.125h.375M3 15h18" />
  </svg>
);
...
export const CogIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0115 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1015 0m-15 0H12m9 0a9 9 0 00-9-9m9 9a9 9 0 01-9 9m9-9v9m-9-9v-9" />
    </svg>
);
...
export const ArchiveBoxIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-3.375-3.375h-13.5L3 7.5" />
  </svg>
);

// FIX: Added DocumentArrowDownIcon
