...
class ErrorBoundary extends React.Component<Props, State> {
  ...
  handleRedirect = () => {
    // FIX: Property 'setState' does not exist on type 'ErrorBoundary'. It should be called on the class instance.
    this.setState({ hasError: false, error: undefined });
    // FIX: Property 'props' does not exist on type 'ErrorBoundary'. It should be accessed on the class instance.
