...
interface ModulInscriereExamenProps {
...
export const ModulInscriereExamen: React.FC<ModulInscriereExamenProps> = ({ sesiune, sportivi, allInscrieri, grade, setInscrieri }) => {
