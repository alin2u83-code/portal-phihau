...
export const ExameneManagement: React.FC<{ onBack: () => void; examene: Examen[]; setExamene: React.Dispatch<React.SetStateAction<Examen[]>>; participari: Participare[]; setParticipari: React.Dispatch<React.SetStateAction<Participare[]>>; sportivi: Sportiv[]; grade: Grad[]; preturiConfig: PretConfig[]; plati: Plata[]; setPlati: React.Dispatch<React.SetStateAction<Plata[]>>; onNavigate?: (view: View, state?: any) => void; navigationState?: any; }> = ({ onBack, examene, setExamene, participari, setParticipari, sportivi, grade, preturiConfig, plati, setPlati, onNavigate, navigationState }) => {
  ...
  if(selectedExamen) { return <ExamenDetail examen={selectedExamen} participari={participari} setParticipari={setParticipari} sportivi={sportivi} grade={grade} onBack={() => setSelectedExamen(null)} preturiConfig={preturiConfig} plati={plati} setPlati={setPlati} examene={examene} onNavigate={onNavigate} />; }
