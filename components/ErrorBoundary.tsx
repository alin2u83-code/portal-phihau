...
class ErrorBoundary extends React.Component<Props, State> {
  ...
  // FIX: Converted to a standard class method. The `this` context is now correctly bound by using an arrow function in the `onClick` handler below. This ensures `this.setState` and `this.props` are accessible.
  handleRedirect() {
