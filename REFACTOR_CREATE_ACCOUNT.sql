-- 1. Funcție SQL pentru crearea/refactorizarea contului de utilizator
-- Această funcție asigură atomicitatea operațiunilor: crearea sportivului și asignarea rolurilor.
...
-- 2. Trigger pentru sincronizarea automată a metadatelor (Opțional dar recomandat)
-- Aceasta asigură că Supabase Auth are metadatele corecte pentru contextul utilizatorului.
