...
export const UnifiedDashboard: React.FC<UnifiedDashboardProps> = ({ session, currentUser, onNavigate, deconturiFederatie }) => {
    ...
    const navItems = [
        ...
        { title: 'Activități Naționale', description: 'Organizează competiții și stagii naționale Qwan Ki Do.', icon: TrophyIcon, view: 'activitati-nationale' as View, category: 'Gestiune', roles: ['ADMIN', 'ADMIN_CLUB', 'INSTRUCTOR', 'SUPER_ADMIN_FEDERATIE'], imageSeed: 'tournament' },
