...
class ErrorBoundary extends React.Component<Props, State> {
  ...
  // FIX: Converted `handleRedirect` to an arrow function property to correctly bind `this`.
  // This resolves errors where `this.setState` and `this.props` were not found when called from an event handler.
