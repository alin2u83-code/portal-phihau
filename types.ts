...
export type View = 'dashboard' | 'sportivi' | 'activitati' | 'raport-prezenta' | 'plati-scadente' | 'jurnal-incasari' | 'raport-financiar' | 'configurare-preturi' | 'tipuri-abonament' | 'familii' | 'user-management' | 'editare-profil-personal' | 'evenimentele-mele';