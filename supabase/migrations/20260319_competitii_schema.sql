...
CREATE TABLE IF NOT EXISTS public.categorii_competitie (
    ...
    min_participanti_start  INTEGER DEFAULT 3,
    ordine_afisare          INTEGER DEFAULT 0
);
...
-- Helper: is_admin() — super admin sau admin club
-- (reutilizat în toate politicile)

-- competitii: toți autentificații pot vedea
