...
- [ ] **Phase 1: DB & Types** - Migrație `program_antrenamente` + tip preț stagiu + update Antrenament type
...
**Plans**: 1 plan
Plans:
- [ ] 01-01-PLAN.md — Migrații status+motiv_anulare & pret + update types.ts (DB-01, DB-02, DB-03)
**UI hint**: no
...
|-------|----------------|--------|-----------|
| 1. DB & Types | 0/? | Not started | - |
| 2. Navigare Grupe Drill-Down | 0/? | Not started | - |
